<template>
  <div class="user table">
    ...
    >
      ...
      <el-table-column prop="username" show-overflow-tooltip label="用户姓名"> </el-table-column>
      <el-table-column prop="mobile" show-overflow-tooltip label="登录名"> </el-table-column>
      <el-table-column
        prop="userType"
      ...
      <el-table-column prop="timeCreate" width="140" label="创建时间"> </el-table-column>
      <el-table-column prop="timeLogin" width="140" label="最后登录时间"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    formatterStorage(row, column, cellValue) {
