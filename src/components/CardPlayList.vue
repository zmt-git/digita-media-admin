...
<template>
  <div
    class="card-play-list"
    :class="[disabled ? 'disabled' : '', isAdd ? 'flex-center' : '']"
    @click="add"
  >
    <template v-if="!isAdd">
      <div class="media">
        <i
          class="iconfont icon-zuo media_icon"
          :class="disabled ? 'disabled' : ''"
          title="左移"
          @click="move('left')"
        ></i>
        <div class="media_box">
          <el-image fit="contain" class="media_img" :src="url" :preview-src-list="[url]">
        ...
        <i
          class="iconfont icon-you media_icon"
          :class="disabled ? 'disabled' : ''"
          title="右移"
          @click="move('right')"
        ></i>
